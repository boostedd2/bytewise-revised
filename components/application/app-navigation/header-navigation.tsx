  ...
  return (
    <>
      <MobileNavigationHeader>
        <aside className="flex h-full max-w-full flex-col justify-between overflow-auto border-r border-secondary bg-primary pt-6 lg:pt-6">
          <div className="flex flex-col gap-5 px-4 lg:px-5">
            <img
              src="/logos/logo_transparency_lightbg.webp"
              height="16px"
              width="154px"
            />
          </div>
